...
When executing as Custom PHP in The TMMData Foundation Platform, the SDK is already included as well as a few helpful GUIDs to aid in your development. A JSON object is passed to your script that includes the source_guid of the table that the DataProcess is tied to, and your user_guid.
